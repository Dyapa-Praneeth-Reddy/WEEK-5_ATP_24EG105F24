...
const products = [
  ...
  },
  {
    ...
    category: "jewelery",
    image: "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcTfm3BprDuNjOZSLJFHTHrcr1JGXoor8wWD19e0IoXPYdnTONLXgq-LvdcrFCmjXNTbOgS3gpqyaNjSbXV16gz2T0sDuceUwjByYNwmhPr-GPaO0jAS2Js76uU",
    rating: {
      rate: 3.9,
      count: 70
    }
...
function App() {
  // Requirement: Render 6 Product components, 3 per row.
